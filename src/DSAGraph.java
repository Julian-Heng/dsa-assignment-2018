...
public class DSAGraph<E,F>
{
    ...
    /**
     *  Name:     displayDepthFirstSearch
     *  Purpose:  Displays the depth first search
     *  Imports:
     *    - none
     *  Exports:
     *    - none
    ...
    /**
     *  Name:     displayBreadthFirstSearch
     *  Purpose:  Displays the breadth first search
     *  Imports:
     *    - none
     *  Exports:
     *    - none
     ...
     *  Purpose:  Returns the depth first search
     *  Imports:
     *    - none
     *  Exports:
     *    - path : A String for the depth first search
     **/
     ...
     *  Purpose:  Returns the breadth first search
     *  Imports:
     *    - none
     *  Exports:
     *    - path : A String for the breadth first search
     **/
